...
<div class="fixed right-0 top-0 h-screen flex z-30 justify-end lg:justify-center lg:w-full lg:block lg:relative lg:h-auto">
	<div class="menuWrap absolute bg-[#efebe4] top-0 h-full z-60 overflow-y-auto transition-all duration-500 opacity-0 pointer-events-none w-[21vw] -left-[21vw] xl:w-[30vw] xl:-left-[30vw] xl:zoom-85 lg:left-auto lg:w-full lg:fixed">
