		...
		<div class="mb-28" id="app">
			<section class="pb-16 border-b border-white mb-10">
				...
				<ul class="flex items-center space-x-6">
					<li class="text-orange-300 px-4 py-2 font-mono text-5xl category-border-radius" :class="[ cat1 == 0 ? 'bg-blue': 'bg-gray-400']" @click="cat1Handler(0)">A</li>
					<li class="text-orange-300 px-4 py-2 font-mono text-5xl category-border-radius" :class="[ cat1 == 1 ? 'bg-blue': 'bg-gray-400']" @click="cat1Handler(1)">B</li>
					<li class="text-orange-300 px-4 py-2 font-mono text-5xl category-border-radius" :class="[ cat1 == 2 ? 'bg-blue': 'bg-gray-400']" @click="cat1Handler(2)">C</li>
				</ul>
				<article class="mt-7">
			...
			<section>
				...
				<ul class="flex items-center space-x-6">
					<li class="text-orange-300 px-4 py-2 font-mono text-5xl category-border-radius" :class="[ cat2 == 0 ? 'bg-blue': 'bg-gray-400']" @click="cat2Handler(0)">A</li>
					<li class="text-orange-300 px-4 py-2 font-mono text-5xl category-border-radius" :class="[ cat2 == 1 ? 'bg-blue': 'bg-gray-400']" @click="cat2Handler(1)">B</li>
					<li class="text-orange-300 px-4 py-2 font-mono text-5xl category-border-radius" :class="[ cat2 == 2 ? 'bg-blue': 'bg-gray-400']" @click="cat2Handler(2)">C</li>
				</ul>
				<article class="mt-7">
					<transition name="fade" mode="out-in">
