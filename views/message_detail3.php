...
<body>
	...
	<div class="relative mt-9 mb-16 category-border-radius">
		<img src="images/message-pic-3.jpg">
	...
	<div class="px-8 text-black-400 text-justify text-[14px] mb-[64px]">
		民國96年立法院將中南部服務中心及議政博物館設在園區內，立法院的精神也帶進園區，讓園區在民主化上的角色又更添新的意義，參議會、臨時省議會、省議會、省議員、立法委員等都是為人民喉舌的民意代表，若將這些歷史完整串連訴說，可讓園區對於民主的議題能有更多元化的呈現。<br>
		<br>
		園區入口椰林大道進入後，途經圓形花圃、議員會館(議蘆會館)<br>、民主草坪、議政博物館、朝琴紀念館以及屋頂圓弧造型的議事大樓等景觀建築，處處綠美化庭園造景，漫步其中令人心曠神怡，後山還有典雅的梅亭，假日是民眾休閒運動的好去處。<br>
		<br>
		園區內議員餐廳現由霧峰區農會承租，改名為「議蘆會館」，主要設施有餐廳、咖啡廳、會議室等，並供團體或個人於園區內辦理議政相關之教育訓練、研習、學術交流、會議及參訪需求之住宿。<br>
		<br>
		<div class="-mx-4"><img src="images/message-pic-3-1.jpg"></div>
	</div>
