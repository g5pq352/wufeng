	...
	<div class="flex lg:block lg:mr-0">
		...
		<div class="w-[35vw] lg:w-full">
			...
			<div class="px-8 text-black-400 text-justify text-[14px] mb-[64px]">
				...
				<br>
				開放民間製酒後，有志於清酒的釀酒廠不少，當中最離奇案例，算是霧峰農會所成立的霧峰農會酒莊，在毫無技術與文化背景下因而傾力投入釀酒令人百思不解，探究後，發現霧峰農會最初投入酒業的動機單純，主要是為了提升「益全香米」品牌，開拓二級與三級加工產品，而100%純米釀造的清酒就成了希望寄託。<br>
				<br>
				<div class="-mx-4"><img src="images/eat-2.jpg"></div>
				<br>
				在日本酒權威東北大學廣井忠夫博士的指導下，霧峰農會酒莊在環境不行、品種不行、支援不行的情況下，逐一破解難題。<br>
				<br>
