	...
	function paginate()
	{
		...
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)
			{
				...
				<span class='font-light text-[15px] text-[#827646] px-4'>$i</span>
				<span class='opacity-100 absolute inset-x-0 -bottom-[15px] h-[2px] bg-green transition-all duration-300'></span></a> ":"<a class=\"relative -top-1 group paginate\" href=\"$_SERVER[PHP_SELF]?page=$i&ipp=$this->items_per_page$this->querystring#listAnchor\">
				<span class='font-light text-[15px] text-[#827646] px-4'>$i</span>
				<span class='opacity-25 absolute inset-x-0 -bottom-[15px] h-[2px] bg-green transition-all duration-300 group-hover:opacity-100'></span></a> ";
			}
