...
if (isset($_SESSION['selected_mapC'])) {
    $G_selected1 = $_SESSION['selected_mapC'];
}
...
$query_RecmapY = "SELECT * FROM class_set WHERE c_parent = 'mapY' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
$RecmapY = $conn->query($query_RecmapY);
$row_RecmapY = $RecmapY->fetch();
$totalRows_RecmapY = $RecmapY->rowCount();
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_RecmapC['c_id']?>" <?php if (!(strcmp($row_RecmapC[ 'c_id'], $G_selected1))) {echo "selected";} ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data6" type="text" class="table_data" id="d_data6" value="" size="80">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = "INSERT INTO data_set (d_title, d_slug, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_data1, d_data2, d_data3, d_data4, d_data5, d_data6, d_description, d_date, d_active) VALUES (:d_title, :d_slug, :d_content, :d_class1, :d_class2, :d_class3, :d_class4, :d_class5, :d_class6, :d_data1, :d_data2, :d_data3, :d_data4, :d_data5, :d_data6, :d_description, :d_date, :d_active)";
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "mapFile", "add");
    ...
    $insertGoTo = "map_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
