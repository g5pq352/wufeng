...
$colname_RectourC = "-1";
if (isset($_GET['c_id'])) {
    $colname_RectourC = $_GET['c_id'];
}

$query_RectourC = "SELECT * FROM class_set WHERE c_id = :c_id";

$RectourC = $conn->prepare($query_RectourC);
$RectourC->bindParam(':c_id', $colname_RectourC, PDO::PARAM_INT);
$RectourC->execute();
$row_RectourC = $RectourC->fetch();
$totalRows_RectourC = $RectourC->rowCount();

$query_RecCCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'tourCCover'";
$RecCCover = $conn->prepare($query_RecCCover);
$RecCCover->bindParam(':file_d_id', $colname_RectourC, PDO::PARAM_INT);
$RecCCover->execute();
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_title" type="text" class="table_data" id="c_title" value="<?php echo $row_RectourC['c_title']; ?>" size="50" />
                                                                                <input name="c_id" type="hidden" id="c_id" value="<?php echo $row_RectourC['c_id']; ?>" />
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="532">
                                                                                <textarea name="c_title_en" cols="60" rows="2" class="table_data" id="c_title_en"><?php echo $row_RectourC['c_title_en']; ?></textarea>
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td width="532">
                                                                                <textarea name="c_content" cols="60" rows="4" class="table_data" id="c_content"><?php echo $row_RectourC['c_content']; ?></textarea>
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6"> </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_data1" type="text" class="table_data" id="c_data1" value="<?php echo $row_RectourC['c_data1']; ?>" size="50" />
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <select name="c_active" class="table_data" id="c_active">
                                                                                    <option value="0" <?php if (!(strcmp(0, $row_RectourC[ 'c_active']))) {echo "selected";} ?>>不公佈</option>
                                                                                    <option value="1" <?php if (!(strcmp(1, $row_RectourC[ 'c_active']))) {echo "selected";} ?>>公佈</option>
                                                                                </select>
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCCover['file_id'].'&type=tourCCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCCover['file_id'].'&type=tourCCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                                                        <td align="center">&nbsp;</td>
                                                                                    </tr>
                                                                                </table>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $updateSQL = "UPDATE class_set SET c_title=:c_title, c_title_en=:c_title_en, c_slug=:c_slug, c_class=:c_class, c_content=:c_content, c_link=:c_link, c_data1=:c_data1, c_active=:c_active WHERE c_id=:c_id";
