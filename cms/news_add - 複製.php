...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = "INSERT INTO data_set (d_title, d_slug, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_data1, d_data2, d_data3, d_data4, d_description, d_date, d_level, d_active) VALUES (:d_title, :d_slug, :d_content, :d_class1, :d_class2, :d_class3, :d_class4, :d_class5, :d_class6, :d_data1, :d_data2, :d_data3, :d_data4, :d_description, :d_date, :d_level, :d_active)";
    ...
    // Cover
    $image_result = image_process($conn, isset($_FILES['imageCover']), isset($_REQUEST['image_titleCover']), $menu_is, "add", $imagesSize['newsCover']['IW'], $imagesSize['newsCover']['IH']);
