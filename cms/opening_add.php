...
if (isset($_SESSION['selected_openingC'])) {
    $G_selected1 = $_SESSION['selected_openingC'];
}
...
$query_RecopeningY = "SELECT * FROM class_set WHERE c_parent = 'openingY' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
$RecopeningY = $conn->query($query_RecopeningY);
$row_RecopeningY = $RecopeningY->fetch();
$totalRows_RecopeningY = $RecopeningY->rowCount();
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_RecopeningC['c_id']?>" <?php if (!(strcmp($row_RecopeningC[ 'c_id'], $G_selected1))) {echo "selected";} ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name="d_data1" type="text" class="table_data" id="d_data1" size="80" /></td>
                                                    <td bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <div class="perm" id="perm_1">
                                                            <label for="r1">
                                                                <input name="perm_coffee" type="radio" id="r1" value="1"> 拉鍊窗簾
                                                            </label>
                                                            <label for="r2">
                                                                <input name="perm_coffee" type="radio" id="r2" value="2"> 拼拼簾
                                                            </label>
                                                        </div>
                                                    </td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = "INSERT INTO data_set (d_title, d_title_en, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_data1, d_data2, d_data3, d_data4, d_date, d_active) VALUES (:d_title, :d_title_en, :d_content, :d_class1, :d_class2, :d_class3, :d_class4, :d_class5, :d_class6, :d_data1, :d_data2, :d_data3, :d_data4, :d_date, :d_active)";
    ...
    $stat->bindParam(':d_class1', $class1 = 'opening', PDO::PARAM_STR);
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "openingFile", "add");
    ...
    $insertGoTo = "opening_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
