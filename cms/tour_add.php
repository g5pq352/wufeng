...
if (isset($_SESSION['selected_tourC'])) {
    $G_selected1 = $_SESSION['selected_tourC'];
}
...
$query_RectourY = "SELECT * FROM class_set WHERE c_parent = 'tourY' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
$RectourY = $conn->query($query_RectourY);
$row_RectourY = $RectourY->fetch();
$totalRows_RectourY = $RectourY->rowCount();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_RectourC['c_id']?>" <?php if (!(strcmp($row_RectourC[ 'c_id'], $G_selected1))) {echo "selected";} ?>>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "tourFile", "add");
    ...
    $insertGoTo = "tour_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
