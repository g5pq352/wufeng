...
<?php
if (!1) {
    header("Location: sights_list.php");
}
...
if (isset($_SESSION['selected_sightsC'])) {
    $G_selected1 = $_SESSION['selected_sightsC'];
}
...
$query_RecsightsY = "SELECT * FROM class_set WHERE c_parent = 'sightsY' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
$RecsightsY = $conn->query($query_RecsightsY);
$row_RecsightsY = $RecsightsY->fetch();
$totalRows_RecsightsY = $RecsightsY->rowCount();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_RecsightsC['c_id']?>" <?php if (!(strcmp($row_RecsightsC[ 'c_id'], $G_selected1))) {echo "selected";} ?>>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "sightsFile", "add");
    ...
    $insertGoTo = "sights_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
