...
$query_Recrooms = "SELECT data_set.*, class_set.c_title as c_title FROM data_set LEFT JOIN class_set ON data_set.d_class2 =class_set.c_id WHERE d_id = :d_id";
$Recrooms = $conn->prepare($query_Recrooms);
$Recrooms->bindParam(':d_id', $colname_Recrooms, PDO::PARAM_INT);
$Recrooms->execute();
...
$RecImage->bindParam(':file_d_id', $colname_Recrooms, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'roomsCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_Recrooms, PDO::PARAM_INT);
$RecCover->execute();
$row_RecCover = $RecCover->fetch();
$totalRows_RecCover = $RecCover->rowCount();

$query_RecContent = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'roomsContent'";
$RecContent = $conn->prepare($query_RecContent);
$RecContent->bindParam(':file_d_id', $colname_Recrooms, PDO::PARAM_INT);
$RecContent->execute();
$row_RecContent = $RecContent->fetch();
$totalRows_RecContent = $RecContent->rowCount();

$query_RecroomsC = "SELECT * FROM class_set WHERE c_parent = 'roomsC' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
$RecroomsC = $conn->prepare($query_RecroomsC);
$RecroomsC->execute();
$row_RecroomsC = $RecroomsC->fetch();
$totalRows_RecroomsC = $RecroomsC->rowCount();

$query_RecFile = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'file'";
$RecFile = $conn->prepare($query_RecFile);
$RecFile->bindParam(':file_d_id', $colname_Recrooms, PDO::PARAM_INT);
$RecFile->execute();
$row_RecFile = $RecFile->fetch();
$totalRows_RecFile = $RecFile->rowCount();

$G_selected1 = '';
if (isset($_SESSION['selected_roomsC'])) {
    $G_selected1 = $_SESSION['selected_roomsC'] = $row_Recrooms['d_class2'];
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                                <option value="<?php echo $row_RecroomsC['c_id']?>" <?php if (!(strcmp($row_RecroomsC[ 'c_id'], $row_Recrooms[ 'd_class2']))) {echo "selected";} ?>>
                                                                    <?php echo $row_RecroomsC['c_title']?>
                                                                </option>
                                                                <?php
                                                                } while ($row_RecroomsC = $RecroomsC->fetch());
                                                                $rows = $RecroomsC->rowCount();
                                                                if($rows > 0) {
                                                                   $RecroomsC->execute();
                                                                }
                                                                ?>
                                                ...
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">房</td>
                                                    <td width="532">
                                                        <input name="d_class3" type="text" class="table_data" id="d_class3" value="<?php echo $row_Recrooms['d_class3']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">廳</td>
                                                    <td width="532">
                                                        <input name="d_class4" type="text" class="table_data" id="d_class4" value="<?php echo $row_Recrooms['d_class4']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_class5" type="text" class="table_data" id="d_class5" value="<?php echo $row_Recrooms['d_class5']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
                                                    <td class="table_data"><textarea name="d_content" cols="60" rows="8" class="table_data tiny" id="d_content"><?php echo $row_Recrooms['d_content']; ?></textarea></td>
                                                ...
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">房型特色</td>
                                                    <td width="532">
                                                        <textarea name="d_data1" cols="60" rows="4" class="table_data tiny" id="d_data1"><?php echo $row_Recrooms['d_data1']; ?></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*請按Enter換行，請勿使用編輯器功能</p></td>
                                                </tr>
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">廚房特色</td>
                                                    <td width="532">
                                                        <textarea name="d_data2" cols="60" rows="4" class="table_data tiny" id="d_data2"><?php echo $row_Recrooms['d_data2']; ?></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*請按Enter換行，請勿使用編輯器功能</p></td>
                                                </tr>
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">浴室特色</td>
                                                    <td width="532">
                                                        <textarea name="d_data3" cols="60" rows="4" class="table_data tiny" id="d_data3"><?php echo $row_Recrooms['d_data3']; ?></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*請按Enter換行，請勿使用編輯器功能</p></td>
                                                </tr>
                                                <!-- <tr>
                                                    ...
                                                    <td width="532">
                                                        <textarea name="d_description" cols="60" rows="4" class="table_data" id="d_description"><?php echo $row_Recrooms['d_description']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr> -->
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="0" <?php if (!(strcmp(0, $row_Recrooms[ 'd_active']))) {echo "selected";} ?>>不顯示</option>
                                                            <option value="1" <?php if (!(strcmp(1, $row_Recrooms[ 'd_active']))) {echo "selected";} ?>>顯示</option>
                                                        </select>
                                                    </td>
                                                ...
                                                <?php } // Show if recordset not empty ?>
                                                <?php if ($totalRows_RecContent > 0) { // Show if recordset not empty ?>
                                                <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">目前設計圖片<a name="imageEdit" id="imageEdit"></a></td>
                                                    <td>
                                                        <?php do { ?>
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="100" rowspan="2" align="center"><a href="../<?php echo $row_RecContent['file_link1'].'?'.(mt_rand(1,100000)/100000); ?>" class="fancyboxImg" rel="group" title="<?php echo $row_RecContent['file_title']; ?>"><img src="../<?php echo $row_RecContent['file_link2'].'?'.(mt_rand(1,100000)/100000); ?>" alt="" class="image_frame"/></a></td>
                                                                <td align="left" class="table_data">&nbsp;圖片說明：
                                                                    <?php echo $row_RecContent['file_title']; ?>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" class="table_data">&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecContent['file_id'].'&type=roomsContent'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecContent['file_id'].'&type=roomsContent'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                                <td align="center">&nbsp;</td>
                                                            </tr>
                                                        </table>
                                                        <?php } while ($row_RecContent = $RecContent->fetch()); ?>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*
                                                            <?php echo $imagesSize['roomsContent']['note'];?>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <?php } // Show if recordset not empty ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" bordercolor="#CCCCCC" class="data">
                                                            <tr>
                                                                <td> <span class="table_data">選擇圖片：</span>
                                                                    <input name="imageContent[]" type="file" class="table_data" id="imageContent1" />
                                                                    <br>
                                                                    <span class="table_data">圖片說明：</span>
                                                                    <input name="imageContent_title[]" type="text" class="table_data" id="imageContent_title1"> </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        ...
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="2" id="addF">
                                                            <tr>
                                                                <td height="28">
                                                                    <table border="0" cellspacing="2" cellpadding="2">
                                                                        <tr>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recrooms['d_id'] ?>" class="fancyboxUpload" title="上傳圖片"><img src="image/add.png" width="16" height="16" border="0"></a></td>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recrooms['d_id'] ?>" class="fancyboxUpload table_data">上傳圖片</a></td>
                                ...
                                <input name="d_sort" type="hidden" id="d_sort" value="<?php echo $row_Recrooms['d_sort']; ?>" />
                            </form>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    // Content
    $image_result = image_process($conn, $_FILES['imageContent'], $_REQUEST['imageContent_title'], $menu_is, "add", $imagesSize['roomsContent']['IW'], $imagesSize['roomsContent']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'roomsContent', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "rooms", "add");
    ...
    $_SESSION['original_selected'] = $_SESSION['selected_roomsC'];

    $updateGoTo = "rooms_list.php?selected1=" . $_POST['d_class2'] . "&change_num=1&now_d_id=" . $_POST['d_id'] . "&totalRows=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
