                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="30%" class="list_title">查看董事長的話</td>
                                    <td width="70%">&nbsp;</td>
                                </tr>
                            </table>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <td>
                                        <table width="100%" border="0" cellspacing="3" cellpadding="5" id="forcolor">
                                            ...
                                            <tr>
                                                ...
                                                <td class="table_data"><?php echo (isset($row_RecData['d_data1'])) ? $row_RecData['d_data2'] : '無'; ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" class="table_title">盟主分店</td>
                                                <td class="table_data"><?php echo (isset($row_RecData['d_data3'])) ? $row_RecData['d_data3'] : '無'; ?></td>
                                            </tr>
                                            <!-- <tr>
                                                <td align="center" class="table_title">分店ID</td>
