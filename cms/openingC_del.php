                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td width="532" class="table_data">
                                                        <?php echo $row_RecopeningC['c_title_en']; ?>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr> -->
                                            </table>
...
if ((isset($_REQUEST['c_id'])) && ($_REQUEST['c_id'] != "") && (isset($_REQUEST['delsure']))) {
    ...
    $sql = "SELECT * FROM file_set WHERE file_d_id=:file_d_id AND file_type='openingCatCover'";
    ...
    $deleteSQL = "DELETE FROM file_set WHERE file_d_id=:file_d_id AND file_type='openingCatCover'";
    ...
    $deleteGoTo = "openingC_list.php?delchangeSort=1";
