...
$colname_Reclatest = "-1";
if (isset($_GET['d_id'])) {
    $colname_Reclatest = $_GET['d_id'];
}

$query_Reclatest = "SELECT data_set.*, latest_set.l_title as l_title FROM data_set LEFT JOIN latest_set ON data_set.d_class2 =latest_set.l_id WHERE d_id = :d_id";
$Reclatest = $conn->prepare($query_Reclatest);
$Reclatest->bindParam(':d_id', $colname_Reclatest, PDO::PARAM_INT);
$Reclatest->execute();
$row_Reclatest = $Reclatest->fetch();
$totalRows_Reclatest = $Reclatest->rowCount();
...
$RecImage->bindParam(':file_d_id', $colname_Reclatest, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'latestCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_Reclatest, PDO::PARAM_INT);
$RecCover->execute();
$row_RecCover = $RecCover->fetch();
$totalRows_RecCover = $RecCover->rowCount();

$query_RecContent = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'latestContent'";
$RecContent = $conn->prepare($query_RecContent);
$RecContent->bindParam(':file_d_id', $colname_Reclatest, PDO::PARAM_INT);
$RecContent->execute();
$row_RecContent = $RecContent->fetch();
$totalRows_RecContent = $RecContent->rowCount();

$query_ReclatestC = "SELECT * FROM latest_set WHERE l_parent = 'latestC' AND l_active='1' AND l_id = :l_id ORDER BY l_sort ASC, l_id DESC";
$ReclatestC = $conn->prepare($query_ReclatestC);
$ReclatestC->bindParam(':l_id', $row_Reclatest['d_class2'], PDO::PARAM_INT);
$ReclatestC->execute();
...
$RecFile->bindParam(':file_d_id', $colname_Reclatest, PDO::PARAM_INT);
$RecFile->execute();
...
if (isset($_SESSION['selected_latestC'])) {
    $G_selected1 = $_SESSION['selected_latestC'] = $row_Reclatest['d_class2'];
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                            ...
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <textarea name="d_title" cols="60" rows="3" class="table_data" id="d_title"><?php echo $row_Reclatest['d_title']; ?></textarea>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <textarea name="d_data1" cols="60" rows="4" class="table_data" id="d_data1"><?php echo $row_Reclatest['d_data1']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr <?php if($row_ReclatestC['l_class'] == 1) : ?>hidden<?php endif ?>>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
                                                    <td class="table_data"><textarea name="d_content" cols="60" rows="8" class="table_data tiny" id="d_content"><?php echo $row_Reclatest['d_content']; ?></textarea></td>
                                                ...
                                                <tr <?php if($row_ReclatestC['l_class'] == 1) : ?>hidden<?php endif ?>>
                                                    ...
                                                    <td width="532">
                                                        <textarea name="d_description" cols="60" rows="4" class="table_data" id="d_description"><?php echo $row_Reclatest['d_description']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo $row_Reclatest['d_date']; ?>" size="50" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="0" <?php if (!(strcmp(0, $row_Reclatest[ 'd_active']))) {echo "selected";} ?>>不顯示</option>
                                                            <option value="1" <?php if (!(strcmp(1, $row_Reclatest[ 'd_active']))) {echo "selected";} ?>>顯示</option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'].'&type=latestCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'].'&type=latestCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                                <td align="center">&nbsp;</td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <?php } // Show if recordset not empty ?>
                                                <?php if ($row_ReclatestC['l_class'] == 2) { // Show if recordset not empty ?>
                                                <!-- ========================== 單張單張傳 =========================== -->
                                                <!-- <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">
                                                        <p>上傳圖片</p>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="2" id="addF">
                                                            <tr>
                                                                <td height="28">
                                                                    <table border="0" cellspacing="2" cellpadding="2">
                                                                        <tr>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Reclatest['d_id'] ?>" class="fancyboxUpload" title="上傳圖片"><img src="image/add.png" width="16" height="16" border="0"></a></td>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Reclatest['d_id'] ?>" class="fancyboxUpload table_data">上傳圖片</a></td>
                                ...
                                <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Reclatest['d_id']; ?>" />
                                <input name="d_sort" type="hidden" id="d_sort" value="<?php echo $row_Reclatest['d_sort']; ?>" />
                            </form>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "latest", "add");
    ...
    $updateGoTo = "latest_list.php?selected1=" . $_POST['d_class2'] . "&change_num=1&now_d_id=" . $_POST['d_id'] . "&totalRows=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
