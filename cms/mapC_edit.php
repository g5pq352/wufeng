...
$colname_RecmapC = "-1";
if (isset($_GET['c_id'])) {
    $colname_RecmapC = $_GET['c_id'];
}

$query_RecmapC = "SELECT * FROM class_set WHERE c_id = :c_id";

$RecmapC = $conn->prepare($query_RecmapC);
$RecmapC->bindParam(':c_id', $colname_RecmapC, PDO::PARAM_INT);
$RecmapC->execute();
$row_RecmapC = $RecmapC->fetch();
$totalRows_RecmapC = $RecmapC->rowCount();

$query_RecCCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'mapCCover'";
$RecCCover = $conn->prepare($query_RecCCover);
$RecCCover->bindParam(':file_d_id', $colname_RecmapC, PDO::PARAM_INT);
$RecCCover->execute();
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_title" type="text" class="table_data" id="c_title" value="<?php echo $row_RecmapC['c_title']; ?>" size="50" />
                                                                                <input name="c_id" type="hidden" id="c_id" value="<?php echo $row_RecmapC['c_id']; ?>" />
                                                                            </td>
                                                                        ...
                                                                        <!-- <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_title_en" type="text" class="table_data" id="c_title_en" value="<?php echo $row_RecmapC['c_title_en']; ?>" size="50" />
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr> -->
                                                                        <!-- <tr>
                                                                            ...
                                                                            <td width="532">
                                                                                <textarea name="c_content" cols="60" rows="4" class="table_data" id="c_content"><?php echo $row_RecmapC['c_content']; ?></textarea>
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6"> </td>
                                                                        </tr> -->
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <select name="c_active" class="table_data" id="c_active">
                                                                                    <option value="0" <?php if (!(strcmp(0, $row_RecmapC[ 'c_active']))) {echo "selected";} ?>>不公佈</option>
                                                                                    <option value="1" <?php if (!(strcmp(1, $row_RecmapC[ 'c_active']))) {echo "selected";} ?>>公佈</option>
                                                                                </select>
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCCover['file_id'].'&type=mapCCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCCover['file_id'].'&type=mapCCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                                                        <td align="center">&nbsp;</td>
                                                                                    </tr>
                                                                                </table>
                                                                            ...
                                                                            <td bgcolor="#e5ecf6" class="table_col_title">
                                                                                <p class="red_letter">*
                                                                                    <?php echo $imagesSize['mapCCover']['note'];?>
                                                                                </p>
                                                                            </td>
                                                                        </tr>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    // CCover
    $image_result = image_process($conn, $_FILES['imageCCover'], $_REQUEST['imageCCover_title'], $menu_is, "add", $imagesSize['mapCCover']['IW'], $imagesSize['mapCCover']['IH']);
