...
$colname_Reclife = "-1";
if (isset($_GET['d_id'])) {
    $colname_Reclife = $_GET['d_id'];
}

$query_Reclife = "SELECT * FROM data_set WHERE d_id = :d_id";
$Reclife = $conn->prepare($query_Reclife);
$Reclife->bindParam(':d_id', $colname_Reclife, PDO::PARAM_INT);
$Reclife->execute();
$row_Reclife = $Reclife->fetch();
$totalRows = $Reclife->rowCount();
...
$RecImage->bindParam(':file_d_id', $colname_Reclife, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'lifeCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_Reclife, PDO::PARAM_INT);
$RecCover->execute();
$row_RecCover = $RecCover->fetch();
$totalRows_RecCover = $RecCover->rowCount();

$query_RecSide = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'lifeSide'";
$RecSide = $conn->prepare($query_RecSide);
$RecSide->bindParam(':file_d_id', $colname_Reclife, PDO::PARAM_INT);
$RecSide->execute();
$row_RecSide = $RecSide->fetch();
$totalRows_RecSide = $RecSide->rowCount();

$query_RecCoverTwo = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'lifeCoverTwo'";
$RecCoverTwo = $conn->prepare($query_RecCoverTwo);
$RecCoverTwo->bindParam(':file_d_id', $colname_Reclife, PDO::PARAM_INT);
$RecCoverTwo->execute();
$row_RecCoverTwo = $RecCoverTwo->fetch();
$totalRows_RecCoverTwo = $RecCoverTwo->rowCount();

$query_RecCoverThree = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'lifeCoverThree'";
$RecCoverThree = $conn->prepare($query_RecCoverThree);
$RecCoverThree->bindParam(':file_d_id', $colname_Reclife, PDO::PARAM_INT);
...
$RecFile->bindParam(':file_d_id', $colname_Reclife, PDO::PARAM_INT);
$RecFile->execute();
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Reclife['d_id']; ?>" />
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_Reclife['d_title']; ?>" size="60">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title_en" type="text" class="table_data" id="d_title_en" value="<?php echo $row_Reclife['d_title_en']; ?>" size="60">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_data1" cols="60" rows="7" class="table_data" id="d_data1"><?php echo $row_Reclife['d_data1']; ?></textarea>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">內頁簡介</td>
                                                    <td>
                                                        <textarea name="d_data2" cols="60" rows="7" class="table_data" id="d_data2"><?php echo $row_Reclife['d_data2']; ?></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*小斷行請按Shift+Enter。
                                                            <br /> 輸入區域的右下角可以調整輸入空間的大小。
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_content" cols="60" rows="7" class="table_data tiny" id="d_content"><?php echo $row_Reclife['d_content']; ?></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*小斷行請按Shift+Enter。
                                                            <br /> 輸入區域的右下角可以調整輸入空間的大小。
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_description" cols="60" rows="7" class="table_data" id="d_description"><?php echo $row_Reclife['d_description']; ?></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*小斷行請按Shift+Enter。
                                                            <br /> 輸入區域的右下角可以調整輸入空間的大小。
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo ( ($row_Reclife['d_date']=='') || (!(strcmp(" 0000-00-00 00:00:00 ", $row_Reclife['d_date']))) ) ? date("Y-m-d H:i:s ") : $row_Reclife['d_date']; ?>" size="50">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_level" class="table_data" id="d_level">
                                                            <option value="0" <?php if (!(strcmp(0, $row_Reclife[ 'd_level']))) {echo "selected";} ?>>不顯示</option>
                                                            <option value="1" <?php if (!(strcmp(1, $row_Reclife[ 'd_level']))) {echo "selected";} ?>>顯示</option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="1" <?php if (!(strcmp(1, $row_Reclife[ 'd_active']))) {echo "selected";} ?>>顯示</option>
                                                            <option value="0" <?php if (!(strcmp(0, $row_Reclife[ 'd_active']))) {echo "selected";} ?>>不顯示</option>
                                                        </select>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'].'&type=lifeCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'].'&type=lifeCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*
                                                            <?php echo $imagesSize['lifeCover']['note'];?>
                                                        </p>
                                                    </td>
                                                </tr>
                                                ...
                                                <?php } // Show if recordset not empty ?>
                                                <?php if ($totalRows_RecSide > 0) { // Show if recordset not empty ?>
                                                <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">目前內頁圖片</td>
                                                    <td>
                                                        <?php do { ?>
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="100" rowspan="2" align="center"><a href="../<?php echo $row_RecSide['file_link1']; ?>" class="fancyboxImg" rel="group" title="<?php echo $row_RecSide['file_title']; ?>"><img src="../<?php echo $row_RecSide['file_link2']; ?>" alt="" class="image_frame"/></a></td>
                                                                <td align="left" class="table_data">&nbsp;圖片說明：
                                                                    <?php echo $row_RecSide['file_title']; ?>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" class="table_data">&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecSide['file_id'].'&type=lifeSide'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecSide['file_id'].'&type=lifeSide'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                            </tr>
                                                        </table>
                                                        <?php } while ($row_RecSide = $RecSide->fetch()); ?>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*
                                                            <?php echo $imagesSize['lifeSide']['note'];?>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <?php } // Show if recordset not empty ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" bordercolor="#CCCCCC" class="data" id="pTable">
                                                            <tr>
                                                                <td> <span class="table_data">選擇圖片：</span>
                                                                    <input name="imageSide[]" type="file" class="table_data" id="imageSide1" />
                                                                    <br>
                                                                    <span class="table_data">圖片說明：</span>
                                                                    <input name="image_titleSide[]" type="text" class="table_data" id="image_titleSide1"> </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        ...
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="2" id="addF">
                                                            <tr>
                                                                <td height="28">
                                                                    <table border="0" cellspacing="2" cellpadding="2">
                                                                        <tr>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Reclife['d_id'] ?>" class="fancyboxUpload" title="上傳圖片"><img src="image/add.png" width="16" height="16" border="0"></a></td>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Reclife['d_id'] ?>" class="fancyboxUpload table_data">上傳圖片</a></td>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    // Cover
    $image_result = image_process($conn, $_FILES['imageCover'], $_REQUEST['image_titleCover'], $menu_is, "add", $imagesSize['lifeCover']['IW'], $imagesSize['lifeCover']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'lifeCover', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    // Side
    $image_result = image_process($conn, $_FILES['imageSide'], $_REQUEST['image_titleSide'], $menu_is, "add", $imagesSize['lifeSide']['IW'], $imagesSize['lifeSide']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'lifeSide', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    // CoverTwo
    $image_result = image_process($conn, $_FILES['imageCoverTwo'], $_REQUEST['image_titleCoverTwo'], $menu_is, "add", $imagesSize['lifeCoverTwo']['IW'], $imagesSize['lifeCoverTwo']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'lifeCoverTwo', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    // CoverThree
    $image_result = image_process($conn, $_FILES['imageCoverThree'], $_REQUEST['image_titleCoverThree'], $menu_is, "add", $imagesSize['lifeCoverThree']['IW'], $imagesSize['lifeCoverThree']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'lifeCoverThree', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "life", "add");
