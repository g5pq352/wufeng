                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="30%" class="list_title">刪除維修服務</td>
...
if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
    ...
    $stat->bindParam(':file_d_id', $_REQUEST['d_id'], PDO::PARAM_INT);
    $stat->execute();
    ...
    $sth->bindParam(':file_d_id', $_REQUEST['d_id'], PDO::PARAM_INT);
    $sth->execute();
    ...
    $deleteGoTo = "repair_list.php?delchangeSort=1";
    if (isset($_SERVER['QUERY_STRING'])) {
