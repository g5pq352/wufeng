...
if (isset($_SESSION['selected_neighborhoodC'])) {
    $G_selected1 = $_SESSION['selected_neighborhoodC'];
}
...
$query_RecneighborhoodY = "SELECT * FROM class_set WHERE c_parent = 'neighborhoodY' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
$RecneighborhoodY = $conn->query($query_RecneighborhoodY);
$row_RecneighborhoodY = $RecneighborhoodY->fetch();
$totalRows_RecneighborhoodY = $RecneighborhoodY->rowCount();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_RecneighborhoodC['c_id']?>" <?php if (!(strcmp($row_RecneighborhoodC[ 'c_id'], $G_selected1))) {echo "selected";} ?>>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = "INSERT INTO data_set (d_title, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_data1, d_data2, d_data3, d_data4, d_description, d_date, d_active) VALUES (:d_title, :d_content, :d_class1, :d_class2, :d_class3, :d_class4, :d_class5, :d_class6, :d_data1, :d_data2, :d_data3, :d_data4, :d_description, :d_date, :d_active)";
    ...
    $stat->bindParam(':d_class1', $class1 = 'neighborhood', PDO::PARAM_STR);
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "neighborhoodFile", "add");
    ...
    $insertGoTo = "neighborhood_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
