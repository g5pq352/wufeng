                                            ...
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <?php
                                                        do {
                                                            if (!(strcmp($row_RecmapC['c_id'], $row_Recmap['d_class2']))) {
                                                            echo $row_RecmapC['c_title'];
                                                            }
...
if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
    ...
    $deleteGoTo = "map_list.php?delchangeSort=1&selected1=" . $G_selected1 . "&selected2=" . $G_selected2;
