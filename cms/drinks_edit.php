...
$colname_Recdrinks = "-1";
if (isset($_GET['d_id'])) {
    $colname_Recdrinks = $_GET['d_id'];
}

$query_Recdrinks = "SELECT data_set.*, class_set.c_title as c_title FROM data_set LEFT JOIN class_set ON data_set.d_class2 =class_set.c_id WHERE d_id = :d_id";
$Recdrinks = $conn->prepare($query_Recdrinks);
$Recdrinks->bindParam(':d_id', $colname_Recdrinks, PDO::PARAM_INT);
$Recdrinks->execute();
$row_Recdrinks = $Recdrinks->fetch();
$totalRows_Recdrinks = $Recdrinks->rowCount();
...
$RecImage->bindParam(':file_d_id', $colname_Recdrinks, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'drinksCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_Recdrinks, PDO::PARAM_INT);
$RecCover->execute();
$row_RecCover = $RecCover->fetch();
$totalRows_RecCover = $RecCover->rowCount();

$query_RecContent = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'drinksContent'";
$RecContent = $conn->prepare($query_RecContent);
$RecContent->bindParam(':file_d_id', $colname_Recdrinks, PDO::PARAM_INT);
$RecContent->execute();
...
$RecdrinksC = $conn->prepare($query_RecdrinksC);
$RecdrinksC->execute();
...
$RecFile->bindParam(':file_d_id', $colname_Recdrinks, PDO::PARAM_INT);
$RecFile->execute();
...
if (isset($_SESSION['selected_drinksC'])) {
    $G_selected1 = $_SESSION['selected_drinksC'] = $row_Recdrinks['d_class2'];
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                                <option value="<?php echo $row_RecdrinksC['c_id']?>" <?php if (!(strcmp($row_RecdrinksC[ 'c_id'], $row_Recdrinks[ 'd_class2']))) {echo "selected";} ?>>
                                                        ...
                                                        <div class="perm" id="perm_1">
                                                            <!-- <?php do { ?>
                                                                <label for="city<?php echo $row_ReccityC['c_id']?>" style="padding-right: 10px;">
                                                                    <input name="d_data1[]" type="checkbox" id="city<?php echo $row_ReccityC['c_id']?>" value="<?php echo $row_ReccityC['c_id']?>" style="cursor: pointer; position: relative; top: 2px;" <?php if (in_array($row_ReccityC['c_id'], explode(",", $row_Recdrinks['d_data1']))): ?> checked="checked"
                                                                    <?php endif ?>>
                                                                ...
                                                                <label for="city1" style="padding-right: 10px;">
                                                                    <input name="d_data1" type="checkbox" id="city1" value="5" style="cursor: pointer; position: relative; top: 2px;" <?php if (in_array(5, explode(",", $row_Recdrinks['d_data1']))): ?> checked="checked"
                                                                    <?php endif ?>>
                                                                    北部
                                                                </label>
                                                                <label for="city2" style="padding-right: 10px;">
                                                                    <input name="d_data2" type="checkbox" id="city2" value="4" style="cursor: pointer; position: relative; top: 2px;" <?php if (in_array(4, explode(",", $row_Recdrinks['d_data2']))): ?> checked="checked"
                                                                    <?php endif ?>>
                                                                    中部
                                                                </label>
                                                                <label for="city3" style="padding-right: 10px;">
                                                                    <input name="d_data3" type="checkbox" id="city3" value="3" style="cursor: pointer; position: relative; top: 2px;" <?php if (in_array(3, explode(",", $row_Recdrinks['d_data3']))): ?> checked="checked"
                                                                    <?php endif ?>>
                                                                    南部
                                                                </label>
                                                                <label for="city4" style="padding-right: 10px;">
                                                                    <input name="d_data4" type="checkbox" id="city4" value="2" style="cursor: pointer; position: relative; top: 2px;" <?php if (in_array(2, explode(",", $row_Recdrinks['d_data4']))): ?> checked="checked"
                                                                    <?php endif ?>>
                                                                    東部
                                                                </label>
                                                                <label for="city5" style="padding-right: 10px;">
                                                                    <input name="d_data5" type="checkbox" id="city5" value="1" style="cursor: pointer; position: relative; top: 2px;" <?php if (in_array(1, explode(",", $row_Recdrinks['d_data5']))): ?> checked="checked"
                                                                    <?php endif ?>>
                                                                    離島
                                                                </label>
                                                        </div>
                                                    ...
                                                    <td class="table_data">
                                                        <div class="perm" id="perm_1">
                                                                <label for="hotcold1" style="padding-right: 10px;">
                                                                    <input name="d_data6" type="checkbox" id="hotcold1" value="1" style="cursor: pointer; position: relative; top: 2px;" <?php if (in_array(1, explode(",", $row_Recdrinks['d_data6']))): ?> checked="checked"
                                                                    <?php endif ?>>
                                                                    COLD
                                                                </label>
                                                                <label for="hotcold2" style="padding-right: 10px;">
                                                                    <input name="d_data7" type="checkbox" id="hotcold2" value="1" style="cursor: pointer; position: relative; top: 2px;" <?php if (in_array(1, explode(",", $row_Recdrinks['d_data7']))): ?> checked="checked"
                                                                    <?php endif ?>>
                                                                    HOT
                                                                </label>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_Recdrinks['d_title']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <!-- <tr>
                                                    ...
                                                    <td width="532">
                                                        <textarea name="d_data1" cols="60" rows="4" class="table_data" id="d_data1"><?php echo $row_Recdrinks['d_data1']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr> -->
                                                <!-- <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
                                                    <td class="table_data"><textarea name="d_content" cols="60" rows="8" class="table_data tiny" id="d_content"><?php echo $row_Recdrinks['d_content']; ?></textarea></td>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td width="532">
                                                        <textarea name="d_description" cols="60" rows="4" class="table_data" id="d_description"><?php echo $row_Recdrinks['d_description']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr> -->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo $row_Recdrinks['d_date']; ?>" size="50" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="0" <?php if (!(strcmp(0, $row_Recdrinks[ 'd_active']))) {echo "selected";} ?>>不顯示</option>
                                                            <option value="1" <?php if (!(strcmp(1, $row_Recdrinks[ 'd_active']))) {echo "selected";} ?>>顯示</option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'].'&type=drinksCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'].'&type=drinksCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                                <td align="center">&nbsp;</td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="2" id="addF">
                                                            <tr>
                                                                <td height="28">
                                                                    <table border="0" cellspacing="2" cellpadding="2">
                                                                        <tr>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recdrinks['d_id'] ?>" class="fancyboxUpload" title="上傳圖片"><img src="image/add.png" width="16" height="16" border="0"></a></td>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recdrinks['d_id'] ?>" class="fancyboxUpload table_data">上傳圖片</a></td>
                                ...
                                <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Recdrinks['d_id']; ?>" />
                                <input name="d_sort" type="hidden" id="d_sort" value="<?php echo $row_Recdrinks['d_sort']; ?>" />
                            </form>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $updateSQL = "UPDATE data_set SET d_title=:d_title, d_content=:d_content, d_class2=:d_class2, d_class3=:d_class3, d_class4=:d_class4, d_class5=:d_class5, d_class6=:d_class6, d_data1=:d_data1, d_data2=:d_data2, d_data3=:d_data3, d_data4=:d_data4, d_data5=:d_data5, d_data6=:d_data6, d_data7=:d_data7, d_description=:d_description, d_date=:d_date, d_active=:d_active WHERE d_id=:d_id";
    ...
    $stat->bindParam(':d_data1', $_POST['d_data1'], PDO::PARAM_STR); //implode(",", $_POST['d_data1'])
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "drinks", "add");
    ...
    $updateGoTo = "drinks_list.php?selected1=" . $_POST['d_class2'] . "&change_num=1&now_d_id=" . $_POST['d_id'] . "&totalRows=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
