...
<?php
if (!1) {
    header("Location: openingC_list.php");
}
...
$colname_RecopeningC = "-1";
if (isset($_GET['c_id'])) {
    $colname_RecopeningC = $_GET['c_id'];
}

$query_RecopeningC = "SELECT * FROM class_set WHERE c_id = :c_id";

$RecopeningC = $conn->prepare($query_RecopeningC);
$RecopeningC->bindParam(':c_id', $colname_RecopeningC, PDO::PARAM_INT);
$RecopeningC->execute();
$row_RecopeningC = $RecopeningC->fetch();
$totalRows_RecopeningC = $RecopeningC->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'openingCatCover' ORDER BY file_sort ASC";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_RecopeningC, PDO::PARAM_INT);
$RecCover->execute();
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_title" type="text" class="table_data" id="c_title" value="<?php echo $row_RecopeningC['c_title']; ?>" size="50" />
                                                                                <input name="c_id" type="hidden" id="c_id" value="<?php echo $row_RecopeningC['c_id']; ?>" />
                                                                            </td>
                                                                        ...
                                                                        <!-- <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_data1" type="text" class="table_data" id="c_data1" value="<?php echo $row_RecopeningC['c_data1']; ?>" size="50" />
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr> -->
                                                                        <!-- <tr>
                                                                            <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
                                                                            <td><textarea name="c_content" cols="60" rows="8" class="table_data" id="c_content"><?php echo $row_RecopeningC['c_content']; ?></textarea></td>
                                                                        ...
                                                                        <!-- <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_data2" type="text" class="table_data" id="c_data2" value="<?php echo $row_RecopeningC['c_data2']; ?>" size="50" />
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_data3" type="text" class="table_data" id="c_data3" value="<?php echo $row_RecopeningC['c_data3']; ?>" size="50" />
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr> -->
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <select name="c_active" class="table_data" id="c_active">
                                                                                    <option value="0" <?php if (!(strcmp(0, $row_RecopeningC[ 'c_active']))) {echo "selected";} ?>>不公佈</option>
                                                                                    <option value="1" <?php if (!(strcmp(1, $row_RecopeningC[ 'c_active']))) {echo "selected";} ?>>公佈</option>
                                                                                </select>
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td id="draggable">
                                                                                ...
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" data-id="<?= $row_RecCover['file_id'] ?>">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'].'&type=openingCatCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'].'&type=openingCatCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                                                        <td align="center">&nbsp;</td>
                                                                                    </tr>
                                                                                </table>
                                                                            ...
                                                                            <td bgcolor="#e5ecf6" class="table_col_title">
                                                                                <p class="red_letter">*
                                                                                    <?php echo $imagesSize['openingCatCover']['note'];?>
                                                                                </p>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    // Cover
    $image_result = image_process($conn, $_FILES['imageCover'], $_REQUEST['imageCover_title'], $menu_is, "add", $imagesSize['openingCatCover']['IW'], $imagesSize['openingCatCover']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_type', $type = 'openingCatCover', PDO::PARAM_STR);
