                                            ...
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <?php
                                                        do {
                                                            if (!(strcmp($row_RecopeningC['c_id'], $row_Recopening['d_class2']))) {
                                                            echo $row_RecopeningC['c_title'];
                                                            }
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <?php echo nl2br($row_Recopening['d_title']); ?>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <?php echo $row_Recopening['d_date']; ?>
                                                    </td>
                                                    <td bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                            </table>
...
if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
    ...
    $deleteGoTo = "opening_list.php?delchangeSort=1&selected1=" . $G_selected1 . "&selected2=" . $G_selected2;
