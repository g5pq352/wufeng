...
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="indexprojectsCover")){
    $fileType = "file_type='indexprojectsCover' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="freshCover")){
    $fileType = "file_type='freshCover' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="indexprojectsCover")){
    $fileType = "file_type='indexprojectsCover' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="projectCover")){
    $fileType = "file_type='projectCover' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="lifeCover")){
    $fileType = "file_type='lifeCover' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="lifeSide")){
