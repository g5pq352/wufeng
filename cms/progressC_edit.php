...
$colname_RecprogressC = "-1";
if (isset($_GET['c_id'])) {
    $colname_RecprogressC = $_GET['c_id'];
}

$query_RecprogressC = "SELECT * FROM class_set WHERE c_id = :c_id";

$RecprogressC = $conn->prepare($query_RecprogressC);
$RecprogressC->bindParam(':c_id', $colname_RecprogressC, PDO::PARAM_INT);
$RecprogressC->execute();
$row_RecprogressC = $RecprogressC->fetch();
$totalRows_RecprogressC = $RecprogressC->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'progressCCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_RecprogressC, PDO::PARAM_INT);
$RecCover->execute();
...
$RecFile->bindParam(':file_d_id', $colname_RecprogressC, PDO::PARAM_INT);
$RecFile->execute();
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_title" type="text" class="table_data" id="c_title" value="<?php echo $row_RecprogressC['c_title']; ?>" size="50" />
                                                                                <input name="c_id" type="hidden" id="c_id" value="<?php echo $row_RecprogressC['c_id']; ?>" />
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <textarea name="c_title_en" cols="50" rows="2" class="table_data" id="c_title_en"><?php echo $row_RecprogressC['c_title_en']; ?></textarea>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_content" type="text" class="table_data" id="c_content" value="<?php echo $row_RecprogressC['c_content']; ?>" size="50" />
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <select name="c_active" class="table_data" id="c_active">
                                                                                    <option value="0" <?php if (!(strcmp(0, $row_RecprogressC[ 'c_active']))) {echo "selected";} ?>>不公佈</option>
                                                                                    <option value="1" <?php if (!(strcmp(1, $row_RecprogressC[ 'c_active']))) {echo "selected";} ?>>公佈</option>
                                                                                </select>
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'].'&type=progressCCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'].'&type=progressCCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                                                        <td align="center">&nbsp;</td>
                                                                                    </tr>
                                                                                </table>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($ifFile) {
        ...
        for ($j = 0; $j < count($file_result); $j++) {
            ...
            $stat->bindParam(':file_d_id', $_POST['c_id'], PDO::PARAM_STR);
