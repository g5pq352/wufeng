...
$colname_RecrepairMail = "-1";
if (isset($_GET['d_id'])) {
    $colname_RecrepairMail = $_GET['d_id'];
}

$query_RecrepairMail = "SELECT * FROM data_set WHERE d_id = :d_id";
$RecrepairMail = $conn->prepare($query_RecrepairMail);
$RecrepairMail->bindParam(':d_id', $colname_RecrepairMail, PDO::PARAM_INT);
$RecrepairMail->execute();
$row_RecrepairMail = $RecrepairMail->fetch();
$totalRows = $RecrepairMail->rowCount();

$query_RecImage = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'image'";
$RecImage = $conn->prepare($query_RecImage);
$RecImage->bindParam(':file_d_id', $colname_RecrepairMail, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'repairMailCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_RecrepairMail, PDO::PARAM_INT);
$RecCover->execute();
...
$RecFile->bindParam(':file_d_id', $colname_RecrepairMail, PDO::PARAM_INT);
$RecFile->execute();
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_RecrepairMail['d_title']; ?>" size="50" />
                                                        <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecrepairMail['d_id']; ?>" />
                                                    </td>
                                                    <td width="250" class="table_col_title red_letter" bgcolor="#e5ecf6">*網頁不顯示</td>
                                                </tr>
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">信箱</td>
                                                    <td width="532">
                                                        <input name="d_class2" type="text" class="table_data" id="d_class2" value="<?php echo $row_RecrepairMail['d_class2']; ?>" size="50" />
                                                    </td>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td width="532">
                                                        <textarea name="d_class3" cols="50" rows="8" class="table_data" id="d_class3"><?php echo $row_RecrepairMail['d_class3']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr> -->
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo ( ($row_RecrepairMail['d_date']=='') || (!(strcmp(" 0000-00-00 00:00:00 ", $row_RecrepairMail['d_date']))) ) ? date("Y-m-d H:i:s ") : $row_RecrepairMail['d_date']; ?>" size="50">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <label>
                                                            <select name="d_active" class="table_data" id="d_active">
                                                                <option value="1" <?php if (!(strcmp(1, $row_RecrepairMail[ 'd_active']))) {echo "selected";} ?>>顯示</option>
                                                                <option value="0" <?php if (!(strcmp(0, $row_RecrepairMail[ 'd_active']))) {echo "selected";} ?>>不顯示</option>
                                                            </select>
                                                        </label>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $updateGoTo = "repairMail_list.php";
    if (isset($_SERVER['QUERY_STRING'])) {
