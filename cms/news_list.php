                            ...
                            <form action="news_process.php" method="post" name="form1" id="form1">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    ...
                                    <tr <?php if ($i%2==0): ?>bgcolor='#E4E4E4'<?php endif ?>>
                                        ...
                                        <!-- <td align="center" class="table_data">
                                            <?php  //list使用
                                            if($row_Recnews['d_level']) {
                                                echo "<a href='".$row_Recnews['d_level']."' rel='".$row_Recnews['d_id']."' class='activeChL'><img src=\"image/accept.png\" width=\"16\" height=\"16\"  ></a>";
                                            } else {
                                                echo "<a href='".$row_Recnews['d_level']."' rel='".$row_Recnews['d_id']."' class='activeChL'><img src=\"image/delete.png\" width=\"16\" height=\"16\"  ></a>";
                                            }
                                            ?>
                                        </td> -->
                                        <td align="center" class="table_data">
