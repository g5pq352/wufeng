...
$colname_Recprogress = "-1";
if (isset($_GET['d_id'])) {
    $colname_Recprogress = $_GET['d_id'];
}

$query_Recprogress = "SELECT data_set.*, class_set.c_title as c_title FROM data_set LEFT JOIN class_set ON data_set.d_class2 =class_set.c_id WHERE d_id = :d_id";
$Recprogress = $conn->prepare($query_Recprogress);
$Recprogress->bindParam(':d_id', $colname_Recprogress, PDO::PARAM_INT);
$Recprogress->execute();
$row_Recprogress = $Recprogress->fetch();
$totalRows_Recprogress = $Recprogress->rowCount();
...
$RecImage->bindParam(':file_d_id', $colname_Recprogress, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'progressCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_Recprogress, PDO::PARAM_INT);
$RecCover->execute();
...
$RecFile->bindParam(':file_d_id', $colname_Recprogress, PDO::PARAM_INT);
$RecFile->execute();
$row_RecFile = $RecFile->fetch();
$totalRows_RecFile = $RecFile->rowCount();

$G_selected1 = '';
if (isset($_SESSION['selected_progressC'])) {
    $G_selected1 = $_SESSION['selected_progressC'] = $row_Recprogress['d_class2'];
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                                <option value="<?php echo $row_RecprogressC['c_id']?>" <?php if (!(strcmp($row_RecprogressC[ 'c_id'], $row_Recprogress[ 'd_class2']))) {echo "selected";} ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Recprogress['d_id']; ?>" />
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_Recprogress['d_title']; ?>" size="60">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <!-- <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">內頁標題1</td>
                                                    <td width="532">
                                                        <input name="d_class3" type="text" class="table_data" id="d_class3" value="<?php echo $row_Recprogress['d_class3']; ?>" size="60">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">內頁標題2</td>
                                                    <td width="532">
                                                        <input name="d_class4" type="text" class="table_data" id="d_class4" value="<?php echo $row_Recprogress['d_class4']; ?>" size="60">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">文章出處</td>
                                                    <td width="532">
                                                        <input name="d_data1" type="text" class="table_data" id="d_data1" value="<?php echo $row_Recprogress['d_data1']; ?>" size="60">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr> -->
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_content" cols="60" rows="7" class="table_data tiny" id="d_content"><?php echo $row_Recprogress['d_content']; ?></textarea>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo $row_Recprogress['d_date']; ?>" size="50" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="0" <?php if (!(strcmp(0, $row_Recprogress[ 'd_active']))) {echo "selected";} ?>>不顯示</option>
                                                            <option value="1" <?php if (!(strcmp(1, $row_Recprogress[ 'd_active']))) {echo "selected";} ?>>顯示</option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'].'&type=progressCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'].'&type=progressCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                                <td align="center">&nbsp;</td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*
                                                            <?php echo $imagesSize['progressCover']['note'];?>
                                                        </p>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="imageEdit">
                                                    ...
                                                    <td id="draggable">
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" data-id="<?= $row_RecImage['file_id'] ?>">
                                                            ...
                                                            <tr>
                                                                <td align="left" class="table_data">&nbsp;圖片內容：
                                                                    <span style="padding-left: 4px;display: inline-block;"><?php echo $row_RecImage['file_content']; ?></span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="2" id="addF">
                                                            <tr>
                                                                <td height="28">
                                                                    <table border="0" cellspacing="2" cellpadding="2">
                                                                        <tr>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recprogress['d_id'] ?>" class="fancyboxUpload" title="上傳圖片"><img src="image/add.png" width="16" height="16" border="0"></a></td>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recprogress['d_id'] ?>" class="fancyboxUpload table_data">上傳圖片</a></td>
                                ...
                                <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Recprogress['d_id']; ?>" />
                                <input name="d_sort" type="hidden" id="d_sort" value="<?php echo $row_Recprogress['d_sort']; ?>" />
                            </form>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    // Cover
    $image_result = image_process($conn, $_FILES['imageCover'], $_REQUEST['imageCover_title'], $menu_is, "add", $imagesSize['progressCover']['IW'], $imagesSize['progressCover']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'progressCover', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "progress", "add");
    ...
    $_SESSION['original_selected'] = $_SESSION['selected_progressC'];

    $updateGoTo = "progress_list.php?selected1=" . $_POST['d_class2'] . "&change_num=1&now_d_id=" . $_POST['d_id'] . "&totalRows=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
