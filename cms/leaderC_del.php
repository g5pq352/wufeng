                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532" class="table_data">
                                                        <?php echo $row_RecleaderC['c_title_en']; ?>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                            </table>
...
if ((isset($_REQUEST['c_id'])) && ($_REQUEST['c_id'] != "") && (isset($_REQUEST['delsure']))) {
    ...
    $sql = "SELECT * FROM data_set WHERE d_class1='leader' AND d_class2=:c_id";
    ...
    $deleteSQL = "DELETE FROM data_set WHERE d_class1='leader' AND d_class2=:c_id";
    ...
    $deleteGoTo = "leaderC_list.php?delchangeSort=1";
