...
if (isset($_SESSION['selected_roomsC'])) {
    $G_selected1 = $_SESSION['selected_roomsC'];
}
...
$query_RecroomsY = "SELECT * FROM class_set WHERE c_parent = 'roomsY' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
$RecroomsY = $conn->query($query_RecroomsY);
$row_RecroomsY = $RecroomsY->fetch();
$totalRows_RecroomsY = $RecroomsY->rowCount();
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_RecroomsC['c_id']?>" <?php if (!(strcmp($row_RecroomsC[ 'c_id'], $G_selected1))) {echo "selected";} ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <textarea name="d_data1" cols="60" rows="4" class="table_data tiny" id="d_data1"></textarea>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <textarea name="d_data2" cols="60" rows="4" class="table_data tiny" id="d_data2"></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*請按Enter換行，請勿使用編輯器功能</p></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <textarea name="d_data3" cols="60" rows="4" class="table_data tiny" id="d_data3"></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*請按Enter換行，請勿使用編輯器功能</p></td>
                                                </tr>
                                                <!-- <tr>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = "INSERT INTO data_set (d_title, d_title_en, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_data1, d_data2, d_data3, d_data4, d_description, d_date, d_active) VALUES (:d_title, :d_title_en, :d_content, :d_class1, :d_class2, :d_class3, :d_class4, :d_class5, :d_class6, :d_data1, :d_data2, :d_data3, :d_data4, :d_description, :d_date, :d_active)";
    ...
    $stat->bindParam(':d_class1', $class1 = 'rooms', PDO::PARAM_STR);
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "roomsFile", "add");
    ...
    $insertGoTo = "rooms_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
