...
if (isset($_SESSION['selected_progressC'])) {
    $G_selected1 = $_SESSION['selected_progressC'];
}
...
$query_RecprogressY = "SELECT * FROM class_set WHERE c_parent = 'progressY' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
$RecprogressY = $conn->query($query_RecprogressY);
$row_RecprogressY = $RecprogressY->fetch();
$totalRows_RecprogressY = $RecprogressY->rowCount();
                                            ...
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_RecprogressC['c_id']?>" <?php if (!(strcmp($row_RecprogressC[ 'c_id'], $G_selected1))) {echo "selected";} ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        ...
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="" size="60">
                                                    </td>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_class3" type="text" class="table_data" id="d_class3" value="" size="60">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_class4" type="text" class="table_data" id="d_class4" value="" size="60">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data1" type="text" class="table_data" id="d_data1" value="" size="60">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr> -->
                                                <!-- <tr>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $stat->bindParam(':d_class1', $class1 = 'progress', PDO::PARAM_STR);
    ...
    $insertGoTo = "progress_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
