...
<?php
if (!1) {
    header("Location: certification_list.php");
}
...
if (isset($_SESSION['selected_certificationC'])) {
    $G_selected1 = $_SESSION['selected_certificationC'];
}
...
$query_ReccertificationY = "SELECT * FROM class_set WHERE c_parent = 'certificationY' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
$ReccertificationY = $conn->query($query_ReccertificationY);
$row_ReccertificationY = $ReccertificationY->fetch();
$totalRows_ReccertificationY = $ReccertificationY->rowCount();
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_ReccertificationC['c_id']?>" <?php if (!(strcmp($row_ReccertificationC[ 'c_id'], $G_selected1))) {echo "selected";} ?>>
                                                ...
                                                <!-- <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
                                                    <td><textarea name="d_title" cols="60" rows="6" class="table_data" id="d_title"></textarea></td>
                                                    <td bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr> -->
                                                <!-- <tr>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $stat->bindParam(':d_class1', $class1 = 'certification', PDO::PARAM_STR);
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "certificationFile", "add");
    ...
    $insertGoTo = "certification_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
