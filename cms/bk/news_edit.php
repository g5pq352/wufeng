...
$query_RecContent = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'newsContent'";
$RecContent = $conn->prepare($query_RecContent);
$RecContent->bindParam(':file_d_id', $colname_Recnews, PDO::PARAM_INT);
$RecContent->execute();
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                                <option value="<?php echo $row_RecnewsC['c_id']?>" <?php if (!(strcmp($row_RecnewsC[ 'c_id'], $row_Recnews[ 'd_class2']))) {echo "selected";} ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <textarea name="d_data1" cols="60" rows="4" class="table_data" id="d_data1"><?php echo $row_Recnews['d_data1']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $updateGoTo = "news_list.php?selected1=" . $_POST['d_class2'] . "&change_num=1&now_d_id=" . $_POST['d_id'] . "&totalRows=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
